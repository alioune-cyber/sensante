...
def predict(patient: PatientInput):
    ...
    Recoit les symptomes en JSON,
    renvoie le diagnostic,
    ...
    messages = {
        ...
        "grippe": (
            "Suspicion de grippe. "
            "Repos et hydratation recommandes."
        ),

        "typh": (
            "Suspicion de typhoide. "
            "Consultation medicale necessaire."
        ),

        "sain": (
            "Pas de pathologie detectee. "
            "Continuez a surveiller."
        )
    }
